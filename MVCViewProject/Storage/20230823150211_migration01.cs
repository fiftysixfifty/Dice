        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstRoll = table.Column<byte>(type: "INTEGER", nullable: false),
                    SecondRoll = table.Column<byte>(type: "INTEGER", nullable: false),
                    Roll = table.Column<byte>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
